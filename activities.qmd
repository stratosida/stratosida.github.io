...
The objective is to develop a checklist for a statistical analysis plan (SAP) for observational studies that accounts for initial data analysis and records deviations from initial plans in one document. 

Lead: Marianne Huebner

Authors: STRATOS wide initiative with authors from several TGs

Project status: **ACTIVE, Paper submitted**

### **Project outcomes:**

1.\  SAPI expanded checklist: [Word](assets/SAPI_checklist_final.docx) or [HTML](sapi.qmd)

2.\  SAPI statement paper

3.\  Explanation & Elaboration paper

4.\  [Documentation of Delphi process](https://doi.org/10.17605/OSF.IO/ZFJAH)
...
1.\ Manuscript for a statistical journal with a "Teaching corner"

2.\ Curated Pokemon data sets (tsv and Rdata)

3.\ Statistical analysis plans for this example (pre- and post-IDA)

4.\ R code and IDA report for initial data analysis 

5.\ R code and Analysis report filen for regression models
...
3.\  IDA plan for the example(s) [check list](assets/IDAchecklist_cross.pdf)
