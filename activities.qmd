...
1.\  SAPI checklist and [expanded checklist](assets/SAPI_checklist_final.docx)
...
The objective is to provide definitions of common terms used by the Initial Data Analysis topics group. Every effort will be made to use existing open access definitions.
...
Glossary of 10-15 terms with definitions, e.g IDA, EDA, MDA, data cleaning, data screening, data quality 
...
5.\ Discussion questions or tasks for the students
