...
An IDA plan is focused on data screening to prepare for statistical analyses; it does not specify software packages to conduct the analyses. It can be
understood as a minimum basic set of analyses that can be extended depending on the context of the research study and data collection. IDA domains unit missingness, item missingness, univariable and multivariable descriptions.
...
Analysis project refers to a systematic and organized data analysis conducted to address one or more research objectives. The analysis project may be using data sources from a study or parent study, defined as the research project that generated the data.
